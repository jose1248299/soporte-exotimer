...
const AI_COMPETITION_CREATION_CONTEXT = [
  ...
  "- Un ticket representa una opcion de compra, no una categoria. Si Open y Pro tienen el mismo precio, moneda, vigencia, cupo, tamano de equipo y condiciones, crea un solo ticket por evento/distancia y vinculalo a todas las categorias permitidas.",
  "- Separa tickets por nivel o categoria solo cuando cambie una condicion comercial o el Timer lo pida expresamente.",
  "- Las categorias indicadas por el Timer son la fuente de verdad. No inventes variantes simetricas ausentes, por ejemplo PRO mujer o PRO dupla mujer/mujer, solo porque existan otras combinaciones Open/Pro.",
  "- Los category_ids de cada ticket deben pertenecer exclusivamente a su event_id. Verifica Catalog y Registration por separado para evitar inscripciones cruzadas.",
  "- Las relaciones de categoria deshabilitadas son historicas: no deben mostrarse, seleccionarse ni vincularse a tickets nuevos.",
...
const TIMER_EVENT_CREATION_CONTEXT = [
  ...
  "- Un ticket es una opcion de compra, no una categoria. Cuando Open y Pro comparten precio, moneda, vigencia, cupo, team_size y demas condiciones, usa un solo ticket por evento/distancia con todas sus categorias validas.",
  "- Solo separa tickets por Open/Pro u otra categoria si cambia una condicion comercial o el Timer lo solicita expresamente.",
  "- Las categorias entregadas por el Timer son exhaustivas. No completes combinaciones simetricas ausentes; si faltan definiciones Open/Pro, pide la lista exacta.",
  "- Cada ticket debe quedar ligado a un unico evento y exactamente a sus category_ids. Nunca mezcles categorias Individual con Duplas ni categorias de otra distancia.",
  "- Catalog puede conservar relaciones de categoria deshabilitadas por historial. Ignoralas para opciones, bindings y verificaciones; si no pueden eliminarse, desactivalas sin afirmar que fueron borradas.",
  "- Despues de crear o consolidar tickets, verifica por separado la configuracion de Catalog y la respuesta de Registration, incluyendo event_id y category_ids exactos.",
